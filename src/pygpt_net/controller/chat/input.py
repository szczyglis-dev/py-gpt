...
class Input:
    ...
    def send(
        ...
        is_agent_judge = is_agent_continue and bool(extra.get("agent_judge"))
        agent_judge_text = str(extra.get("agent_judge_text") or "") if is_agent_judge else ""
        ...
        self.execute(
            ...
            agent_judge=is_agent_judge,
            agent_judge_text=agent_judge_text,
    ...
    def execute(
        ...
        :param agent_judge: continuation instruction was generated by the dynamic judge
        :param agent_judge_text: raw judge response shown as a UI-only pseudo-input
