...
const el=this.dom.get('_loader_');if(!el)return;el.classList.remove('hidden','reserved');el.classList.add('visible');}
hide(reserveSpace=false){const el=this.dom.get('_loader_');if(!el)return;el.classList.remove('visible');if(reserveSpace){el.classList.remove('hidden');el.classList.add('reserved');}else{el.classList.remove('reserved');el.classList.add('hidden');}}}
