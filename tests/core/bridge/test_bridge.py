...
def make_window():
    ...
    window.core.gpt.quick_call = Mock(return_value="quick_result")
    return window
...
def test_call_switches_to_research_and_uses_quick_call(monkeypatch):
    ...
    window.core.gpt.quick_call = Mock(return_value="GPT_OK")
    b = Bridge(window)
...
def test_call_default_quick_call_invoked():
    ...
    window.core.gpt.quick_call = Mock(return_value="DEFAULT")
