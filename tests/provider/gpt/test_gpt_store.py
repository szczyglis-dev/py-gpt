...
def fake_window():
    window = MagicMock()
    client = MagicMock()
    window.core.gpt.get_client.return_value = client
...
def test_get_client(store):
    client = MagicMock()
    store.window.core.gpt.get_client.return_value = client
...
def test_get_file(store):
    ...
    store.window.core.gpt.get_client.return_value = fake_client
