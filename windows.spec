...
a = Analysis(
    ...
    'pywin32-ctypes',
    'tweepy'],
    collectsubmodules=['chromadb', 'chromadb.migrations', 'chromadb.telemetry', 'chromadb.api','chromadb.db', 'httpx', 'httpx-socks', 'nbconvert', 'onnxruntime',  'pywin32', 'pywin32-ctypes'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
