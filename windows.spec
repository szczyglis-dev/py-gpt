...
a = Analysis(
    ...
    datas=collect_data_files('opentelemetry.sdk', 'pinecode') + collect_data_files('chromadb', include_py_files=True, includes=['**/*.py', '**/*.sql']) + [  # chromadb, pinecode hack
        ...
        ('src\\pygpt_net\\data\\js\\highlight\\*', 'data\\js\\highlight'),
        ('src\\pygpt_net\\data\\js\\highlight\\styles\\*', 'data\\js\\highlight\\styles'),
        ('src\\pygpt_net\\data\\js\\highlight\\languages\\*', 'data\\js\\highlight\\languages'),
        ('src\\pygpt_net\\data\\js\\highlight\\es\\*', 'data\\js\\highlight\\es'),
        ('src\\pygpt_net\\data\\js\\highlight\\es\\languages\\*', 'data\\js\\highlight\\es\\languages'),
